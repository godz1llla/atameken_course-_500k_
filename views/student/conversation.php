...
<div class="row m-b-sm">
    <div class="col-sm-12">
        <h2 class="font-bold m-b-xs">
            <i class="ion-ios-email"></i> <?php echo __('messages.conversation_with'); ?> <?php echo htmlspecialchars($teacher['first_name'] . ' ' . $teacher['last_name']); ?>
        </h2>
    </div>
</div>
...
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="ibox-content border-bottom">
            <form id="messageForm" action="/index.php?url=student/sendMessage" method="POST">
